...
export const DatePicker = ({ value, min, onChange, className = "" , formatDisplay} : { value: string, min?: string, onChange: (setStateAction: SetStateAction<string>) => void, className:string, formatDisplay: (isoDate: string) => string} ) => {
